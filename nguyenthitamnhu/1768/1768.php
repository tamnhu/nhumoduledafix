...
require_once 'lib/scss.inc.php';
    ...
    $styles = $scss->compile('@import "1768-styles.scss";');

    $css = fopen('css/1768-styles.css','w');
...
<head>
    ...
    <link href="<?php echo $url_path ?>/css/1768-styles.css" rel="stylesheet" type="text/css" />
